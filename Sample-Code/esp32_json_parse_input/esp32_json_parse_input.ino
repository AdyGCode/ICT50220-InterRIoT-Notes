 ...
 *
 * Reference:
 * - https://zbotic.in/esp32-json-parsing-arduinojson-library-for-api-responses/
 *
...
void setup() {
  ...
  DEBUG_PRINTF("Sensor: %s ", sensor);
  DEBUG_PRINTF("Temp: %.1f°C, Humidity: %d\n", temperature, humidity);

  // Access array
  JsonArray readings = doc["readings"];
  for (float r : readings) {
    DEBUG_PRINTF("Reading: %.1f\n", r);
  }
}
