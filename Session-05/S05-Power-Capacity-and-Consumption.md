...
When you purchase a Lithium-Polymer (LiPo) or Nickle-Cadmium (NiCad) you will find they are labelled with a value in milli-Amp Hours.

### What is milli-Amp Hours?

Batteries are rated in milli-Amp Hours, or mAh.
...
- A battery may supply until its capacity is a minimum value (e.g. 100 mAh), we shall express this as `MinCap`.
...
| Max Cap | Min Cap | Avg Perc | Calc                          | 'Actual' Cap (mAh) |
| ------- | ------- | -------- | ----------------------------- | ------------------ |
| 1000    | 100     | 85%      | `(1000 - 100) * 85 / 100`     | 765                |
| 12,000  | 2500    | 87.5%    | `(12000 - 2500) * 87.5 / 100` | 8312.5             |
...
| Max Cap | Avg Current Draw | Calc           | Duration  |
| ------- | ---------------- | -------------- | --------- |
