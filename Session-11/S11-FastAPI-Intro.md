...
For the final source code we have a repository available.
...
# Set Up Tailwind CSS & Font Awesome

Seeing as we already have encountered Tailwind CSS we may as well also include it in this project.

> ### **IMPORTANT**
> We are using Tailwind CSS v4 and Font Awesome v6 in these notes
...
Open the `templates/components/navigation.html` file and add:
...
- [https://github.com/AdyGCode/xxx-fastapi-site-base](https://github.com/AdyGCode/xxx-fastapi-site-base)
